...
const nonExistentBook = library.findBookBy("releaseDate", 1919);
console.log(nonExistentBook);

const foundBook = library.findBookBy("releaseDate", 1924);
console.log(foundBook.name);

console.log("Количество книг до выдачи: " + library.books.length);

const borrowedBook = library.giveBookByName("Машина времени");
console.log("Выдана книга: " + borrowedBook.name);
